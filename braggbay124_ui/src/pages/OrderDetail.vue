						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="PurchaseDate" type="text" placeholder="Enter PurchaseDate" v-model="orderToAdd.purchaseDate"></base-input>
								  <base-input label="TotalPrice" type="text" placeholder="Enter TotalPrice" v-model="orderToAdd.totalPrice"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Purchase Date</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<datepicker v-model="orderDetails.purchaseDate"  placeholder="Select Date" ></datepicker>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Total Price</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="TotalPrice" type="text" placeholder="Enter TotalPrice" v-model="orderDetails.totalPrice"></input>
																		</div>
						</td>
														</tr>

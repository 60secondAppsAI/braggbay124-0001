					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updateFavorite()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div >
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Favorites = true">Add</base-button>
								              <modal :show.sync="modal2Favorites">
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Favorite Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="FavoriteId" type="text" placeholder="Enter FavoriteId" v-model="favoriteDetails.favoriteId"></input>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  methods: {
    ...
    async updateFavorite() {
      ...
      const jsonData = JSON.stringify(this.favoriteDetails);
      const res = await FavoriteService.update(jsonData);
...
//        this.getAllFavorites();
    ...
    async getFavoriteDetails() {
      try {
			let response = await FavoriteService.get(this.favoriteId);

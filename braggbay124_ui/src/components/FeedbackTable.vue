...
<template>
  ...
  <base-input label="Rating" type="text" placeholder="Enter Rating" v-model="feedbackToAdd.rating"></base-input>
  <base-input label="Comment" type="text" placeholder="Enter Comment" v-model="feedbackToAdd.comment"></base-input>
                  </form>
                </div>

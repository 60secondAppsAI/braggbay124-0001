...
<template>
  ...
  <base-input label="IsRead" type="text" placeholder="Enter IsRead" v-model="notificationToAdd.isRead"></base-input>
                  </form>
                </div>
	...
	<template slot="isRead" slot-scope="dataIndex">
       {{ dataIndex ? 'Yes' : 'No' }}
   </template>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'isRead',
          ...
          sorter: true
          //sorter: (a, b) => a.isRead - b.isRead,
          //sorter: (a, b) => a.isRead.localeCompare(b.isRead),
        },
      ],
      pagination: {
        current: 1,
